...
train_set = ROSE_Dataset(base_data_path=data_dir, data_split="train", transform=train_transforms)
print(f"Number of Train Images: {len(train_set)} | Label Dict: {train_set.labels_dict}")
val_set = ROSE_Dataset(base_data_path=data_dir, data_split="train", transform=train_transforms)
