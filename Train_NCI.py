...
# Train Dataset
train_set = NCI_Dataset(fold="train", path=data_dir, transform=train_transforms, transform_orig=val_transforms)
print(f"Number of Total Train Images: {len(train_set)}")
val_set = NCI_Dataset(fold="test", path=data_dir, transform=val_transforms, transform_orig=val_transforms)
...
train_description = "200E_base_lr4"
